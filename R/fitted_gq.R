...
##'   predictive checks.
##'
##' @param x \code{adrm} object containing the output from the [fit_drm]
##'   function.
...
##'   obkect.
##'
##' @param x A \code{sdm} object containing the output from the [fit_sdm]
##'   function.
##' @param cores number of threads used for the forecast. If four chains were
