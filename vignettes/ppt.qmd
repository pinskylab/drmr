...
| $\xi$      | `xi`      | $\mathrm{logit}(\rho) = \cdots \xi \log(\mu)$ | `rho_mu`                 | ${- \rm LN}(m_lxi, s_lxi)$           | $m_{lxi} = 0, s_{lxi} = 1$    |
