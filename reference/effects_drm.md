...
Evaluates and summarizes the effects_drminal relationships between
...
process. If `summary = TRUE`, it also receives the class `eff_drm` to
enable automated plotting.

## Details

The `effects_drm` function computes the predicted relationships across a
