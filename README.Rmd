...
> package. Otherwise, one get `segmentation fault` errors that are hard to debug
> (and also not a `drmr`, but rather a `cmdstanr` issue). Moreover, we recommend
> installing [`instantiate`](https://github.com/wlandau/instantiate/) from
